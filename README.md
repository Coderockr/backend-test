...
It is necessary to have the docker installed to run the application.
...
Ports 5432 and 3333 must be available.

The .env file with the variables are already defined, use the data contained in this file to connect to other database management tools.
...
### Migrations
Open other terminal to run migrations:
```
$ yarn migrate
```
### **Running the tests**
...
### **List of used development tools**
