  ...
  <div class="con-upload">
    ...
    <div class="con-img-upload">
        <div
          ...
          :class="{
            'fileError':img.error,
            'removeItem':item_remove.includes(index)
          }"
          :key="index"
          class="img-upload">
          <button
      ...
      <div
        :class="{
          ...
          'disabled-upload':$attrs.hasOwnProperty('disabled') || limit?(srcs.length - item_remove.length) >= Number(limit):false
        }"
        class="con-input-upload">
        <input
          ref="fileInput"
          v-bind="$attrs"
          :disabled="$attrs.disabled || limit?(srcs.length - item_remove.length) >= Number(limit):false"
          type="file"
          @change="getFiles">
  ...
  export default {
    ...
    methods:{
      ...
      getFiles(e) {
        ...
        let count = (this.srcs.length - this.item_remove.length)
