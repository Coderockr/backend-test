...
function useSelect(props) {
  ...
  return {
    ...
    getButtonProps: otherHandlers => {
      return (0, _extends2.default)({}, getButtonProps((0, _extends2.default)({}, otherHandlers, {
    ...
    getListboxProps: otherHandlers => getListboxProps((0, _extends2.default)({}, otherHandlers, {
      onBlur: createHandleListboxBlur(otherHandlers),
      onKeyUp: createHandleListboxKeyUp(otherHandlers)
    })),
    getOptionProps: (option, otherHandlers) => {
      return getOptionProps(option, (0, _extends2.default)({}, otherHandlers, {
