...
class InvestmentsAPIv1Test(InvestmentsTestBase):
    ...
    def test_investment_withdrawal_returns_status_code_200(self):
        ...
        print(investment)
        response = self.client.put(f'{self.BASE_URL}{investment}/withdrawn/', data={'withdrawn_date': '2022-10-22'})
        self.assertEqual(
            response.status_code,
            200
        )
    ...
    def test_investments_withdrawal_date_cannot_be_in_the_future_or_before_it_creation_date(self):
